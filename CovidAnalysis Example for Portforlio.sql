...
---Total Cases and Total Deaths vs total population  in target specific continents
...
--Location with Highest IR compared to population
...
Join dbo.CovidVaccinations$ as VAC
 ...
 ---TempTable for PercPopVaccinated
